"""Full-weight Qwen3 4B supervised fine-tuning with PyTorch FSDP2.
...
def load_fsdp_model_and_tokenizer():
    """Load Qwen3 4B weights in bf16 without placing the model."""
    import torch
    ...
    if model.__class__.__name__ != "Qwen3ForCausalLM":
        raise TypeError(
            "Expected AutoModelForCausalLM to load Qwen3ForCausalLM, got "
